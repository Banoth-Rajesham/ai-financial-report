...
def create_professional_pdf(kpis, ai_analysis, company_name):
    ...
    # (PDF generation code is correct)
...
if not st.session_state.report_generated:
    ...
    with col1:
        # Revenue Chart (Code is correct and unchanged)
    with col2:
        # Asset Chart (Code is correct and unchanged)
    
    st.write("") 

    col1, col2 = st.columns([6, 4], gap="large")
    with col1:
        # Profit Margin Chart (Code is correct and unchanged)
    with col2:
        # Ratios Table (Code is correct and unchanged)
