    ...
    if excel_file and company_name_pdf:
        with st.spinner("Processing Excel file and generating report..."):
            try:
                ...
                # Find the sheet that contains the 'Particulars' column
                source_df = None
                ...
                if source_df is not None:
                    ...
                    def find_value(keyword, df_to_search=source_df):
                        ...
                        if not row.empty:
                            # Use iloc to get the value, in case the index is non-standard
                    ...
                    # Construct the aggregated data dictionary from the found values
                    agg_data_from_excel = {
                    ...
                    # Let's try to get it from a specific note sheet if available.
