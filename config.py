...
# This is your full, original structure, enhanced with the aliases from the
...
NOTES_STRUCTURE_AND_MAPPING = {
    ...
    '2': {
        ...
        'sub_items': {
            ...
            'Surplus / (Deficit) in Statement of Profit and Loss': {
                'Balance at the end of the year     ': ['Retained Earnings', 'Surplus', 'P&L Account Balance', 'Profit & Loss A/c']
            }
        }
    },
    '3': {
        ...
        'sub_items': {
            'Term loans from banks': ['Term loans from banks', 'term loan', 'long term borrowings', 'Mortgage Loan'],
            'Other loans and advances': ['Other loans and advances specify nature', 'debentures']
        }
    },
    ...
    '8': {'title': 'Trade payables', 'sub_items': {'Trade payables': ['trade payables', 'sundry creditors']}},
    '9': {'title': 'Other current liabilities', 'sub_items': {'Other current liabilities': ['other current liabilities', 'bills payable', 'outstanding expenses']}},
    '10': {'title': 'Short term provisions', 'sub_items': {'Short term provisions': ['short term provisions', 'provision for tax']}},
    '11': {
        'title': 'Fixed Assets (Tangible & Intangible)',
        'sub_items': {
            'Tangible Assets': ['tangible assets', 'net fixed assets', 'fixed assets', 'land & building', 'plant & machinery', 'motor vehicles', 'Furniture & Fixture'],
            'Intangible Assets': ['Intangible Assets'],
            'Capital Work-in-Progress': ['Capital Work-in-Progress', 'CWIP'],
            'Depreciation': ['Depreciation', 'Depriciation for the year', 'to depreciation']
        }
    },
    ...
    '16': {
        'title': 'Inventories',
        'sub_items': {
            'Stock-in-trade': ['inventories', 'stock/inventories', 'closing stock', 'opening stock', 'to opening stock', 'by closing stock']
        }
    },
    '17': {'title': 'Trade Receivables', 'sub_items': {'Trade Receivables': ['trade receivables', 'sundry debtors', 'bills receivable']}},
    '18': {'title': 'Cash and cash equivalents', 'sub_items': {'Cash and cash equivalents': ['cash and cash equivalents', 'cash at bank', 'cash in hand']}},
    '19': {'title': 'Short term loans and advances', 'sub_items': {'Short term loans and advances': ['short term loans and advances', 'prepaid', 'prepaid expenses']}},
    '20': {'title': 'Other current assets', 'sub_items': {'Other current assets': ['other current assets']}},
    '21': {
        'title': 'Revenue from Operations',
        'sub_items': {
            'Sale of Services': ['revenue from operations', 'by sales', 'sales']
        }
    },
    '22': {
        'title': 'Other income',
        'sub_items': {
            'Other income': ['other income', 'by interest received', 'by dividend received', 'by commission received', 'by discount received', 'by bad debts recovered', 'miscellaneous income']
        }
    },
    '23': {
        'title': 'Cost of Materials Consumed',
        'sub_items': {
            'Purchases': ['cost of materials consumed', 'to purchases', 'purchases']
        }
    },
    '24': {
        'title': 'Employee benefit expenses',
        'sub_items': {
            'Salaries and Wages': ['employee benefit expenses', 'to wages', 'to salaries', 'salary']
        }
    },
    '25': {
        'title': 'Finance Costs',
        'sub_items': {
            'Interest on borrowings': ['finance costs', 'to interest paid', 'interest on borrowings']
        }
    },
    '26': {
        ...
        'sub_items': {
            ...
            'Rent': ['Rent', 'to rent'],
            'Travelling Expense': ['Travelling Expense', 'to transportation'],
