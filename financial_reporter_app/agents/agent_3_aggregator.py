# ==============================================================================
# FILE: agents/agent_3_aggregator.py (CORRECTED WITH COLAB LOGIC)
# ==============================================================================
import pandas as pd

def hierarchical_aggregator_agent(source_df, notes_structure):
    """
    AGENT 3: Uses the flexible keyword search logic from the working Colab
    script to accurately find and sum the financial data.
    """
    ...
    def match_and_aggregate(current_data, current_template, full_df):
        ...
        for key, template_value in current_template.items():
            if isinstance(template_value, dict):
                ...
                # This regex pattern is the core of the working Colab script's logic
